...
export function findMissingTableDeclarations(
  sourceTableNames: Iterable<string>,
  runtimeTableNames: Iterable<string>,
): string[] {
  const sourceNames = new Set(sourceTableNames);
  return [...runtimeTableNames]
